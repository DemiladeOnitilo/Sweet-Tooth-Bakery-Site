...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex justify-center items-center mt-24 overflow-hidden">
      <div
      ...
      <div className="absolute bottom-32 right-16 w-32 h-32 bg-purple-400/20 rounded-full animate-bounce" />
      <div
        className="absolute top-1/3 right-1/4 w-16 h-16 bg-yellow-400/20 rounded-full "
