...
const Navbar = () => {
  ...
  const activeClass = "text-pink-600 font-bold bg-pink-50 px-4 py-2 rounded-full relative";
  const inactiveClass = "text-gray-700 hover:text-pink-600 hover:bg-pink-50 px-4 py-2 rounded-full transition-all duration-300 relative";

  return (
    <>
      <nav className={`bg-white/95 backdrop-blur-md fixed right-0 left-0 top-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* Notifications Bell (Optional Feature) */}
            <button className="hidden md:flex relative p-2 rounded-full hover:bg-pink-50 transition-all duration-300 group">
              <svg className="w-5 h-5 text-gray-700 group-hover:text-pink-600 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5-5V9a4 4 0 00-8 0v3l-5 5h5m8 0v1a3 3 0 01-6 0v-1m6 0H9" />
              </svg>
              ...
              {/* Mobile Menu Button */}
              <button
                className="lg:hidden p-2 rounded-full hover:bg-pink-50 transition-all duration-300 group"
        ...
        <div className={`lg:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-4 pt-4 pb-6 space-y-3 bg-white/95 backdrop-blur-md">
            <NavLink
              onClick={() => { refreshPage(); setIsOpen(false); }}
              to="/About"
              className={({ isActive }) => 
